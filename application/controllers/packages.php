...
//        exit();
    ...
    public function product_detail($slug)
    {
        ...
        //$category_detail  = $this->crud->get_active_not_deleted_detail($package_id, 'category_url', 'igc_package_category');
...
//        $data['breadcrumb_link'] =  $category_slug;
        ...
        $detail = $this->package->get_package_am($slug);
...
//exit();
        ...
        $data['og_url']= 'packages/detail/'.$detail['package_url'];
