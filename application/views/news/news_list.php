                    ...
                    <div class="section listing-news">
                        ...
                        if(!empty($articles))
                        {
                            ...
                            <div id="products" class="row list-group">
                               ...
                               <?php }
                               elseif (!empty($rows['server_image'])) {
                                ?>

                                    <div class="entry-header">
                                            <div class="entry-thumbnail">
                                                <a href="<?php echo site_url('/news/detail/'.$rows['content_id']);?>">
                                                <img class="group list-group-image img-responsive" style="width: 100%;" src="<?php echo $rows['server_image'];?>"  alt="<?php echo $rows['content_title']; ?>" />
                                                </a>
                                            </div>
                                        </div>
...
// var bod = document.getElementsByTagName("h1");
var img = document.getElementsByClassName("group list-group-image img-responsive");
