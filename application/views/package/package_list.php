                    ...
                    if(!empty($IH_parent)) {
                        ...
                        foreach ($IH_parent as $IHP) {
                            ...
                            <li  data-toggle="collapse" data-target="#products<?php echo $i; ?>" class="collapsed active">
                                <a href="<?php echo site_url('packages/index/'.$IHP['category_url']);?>"> <?php echo $IHP['category_name'];?> <?php  if(! empty($child_menu)){ echo "<span class=\"arrow\"></span>";  } ?></a>
                            </li>
                                ...
                                if(! empty($child_menu))
                                {
                                    foreach ($child_menu as $child) {
                                        ...
                                        <li>
                                            ...
                                            {
                                                ?>
                                                <a href="<?php echo site_url('packages/index/'.$IHP['category_url']);?>">
                                                    <?php echo $child['category_name'];?>
                                                </a>
                                                <?php
                                            }
