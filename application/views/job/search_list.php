                ...
                <div class="maid">
                    <div class="col-sm-3 ">
                        <div class="maidprofile">
                            <img src="<?php echo $path.$entry['image'];?>" width="80%;"  id="" class="img-responsive">
                        </div>
                    </div>
                    <div class="col-sm-9">
                        ...
                        <div class="maidprofile_info">
                            ...
                            <div class="maidprofiledetails" >
                                ...
                                <div class="col-sm-1">
     <button type="button" class="btn btn-success pull-right  get-cv" data-toggle="modal" data-target="#myModal-<?php echo $entry['job_id']; ?>">Get CV</button>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </div>
