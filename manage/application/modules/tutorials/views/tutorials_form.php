                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="content_page_title" class="form-control" data-validation="required"  size="50" value="<?php echo (isset($content['content_page_title']) && $content['content_page_title'] !="") ? $content['content_page_title']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="content_type" class="form-control">
                                            <option value="Tutorial"  <?php echo (isset($content['content_type']) && $content['content_type'] =="Tutorial")?"selected":"";?>>Tutorials</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category_id" data-validation="required">
                                            ...
                                            foreach($categories as $cat){
                                                ...
                                                ?>
                                                <option value="<?php echo $cat['category_id'] ?>" <?php echo (isset($content['category_id']) && $content['category_id'] ==$cat['category_id'])?"selected":"";?>><?php echo $cat['category_name']; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        if(isset($content['featured_img']))
                                        {
                                            ...
                                            <div class="remove_option">
                                                ...
                                                ?>
                                                <img src="<?php echo $path. $content['featured_img'];?>" alt="featured_image" style="width: 50%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        if(isset($content['parallex_img']))
                                        {
                                            ...
                                            <div class="remove_option1">
                                                ...
                                                $path  =  '../uploads/content/';
                                                ?>
                                                <img src="<?php echo $path.$content['parallex_img'];?>" alt="parallex_img" style="max-width: 50%;">
