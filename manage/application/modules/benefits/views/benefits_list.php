    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <i class="fa fa-plus-square-o"></i><a href="<?php echo site_url('benefits/form');?>"> Add New </a>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        foreach($records as $row)
                        {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('benefits/form/'. $row['content_id']);?>" class="btn btn-success" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" class="hidden_link_news" value="<?php echo site_url('benefits/send/'. $row['content_id']); ?>">
                                    ...
                                    <div id="myModal_delete<?php echo $row['content_id'];?>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" class="hidden_link_delete" value="<?php echo site_url('benefits/delete/'. $row['content_id']); ?>">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
