                                ...
                                <div class="col-sm-12">
                                    ...
                                    if(isset($records['post_image']))
                                    {
                                        ...
                                        <div class="remove_option">
                                            ...
                                            $path  =  '../uploads/post/';
                                            ?>
                                            <img src="<?php echo $path. $records['post_image'];?>" alt="post_image" style="max-width: 940px; max-height: 360px;">

                                            <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                        </div>
                                        <input type="hidden" name="pre_postimg" value="" data-validation="required">
                                        <div id="image_input">
                                            <input type="file" class="form-control" name="post_image" id="post_image" data-validation="required">
