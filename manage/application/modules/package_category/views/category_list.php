                    ...
                    <div class="tab-pane fade active in" id="home">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-info" data-rel="tooltip" href="<?php echo site_url('package_category/category');?>" title="Add Category"><i class="fa fa-plus-square-o"></i> Add Category</a>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover"  id="dataTables-example">
                                        ...
                                        foreach($categories as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<?php echo site_url('package_category/category/'. $row['category_id']);?>" class="btn btn-success btn-xs" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                                        <a href="<?php echo site_url('package_category/related_packages/'. $row['category_id']);?>" class="btn btn-primary btn-xs" title="Related Product"><i class="fa fa-cogs"></i></a>
                                                        <a class="btn btn-danger btn-xs" data-target="#myModal_delete<?php echo $row['category_id'];?>" data-toggle="modal" title="Delete"><i class="fa fa-trash-o" ></i></a>
                                                    </div>
