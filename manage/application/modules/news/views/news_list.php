...
<a href="<?php echo site_url('news/notification') ?>" class="notification">
  <span>Inbox</span>
  <span class="badge"><?php echo count($this->content->get_notified_article_list()) ?></span>
</a>
<div class="">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="">
                        ...
                        foreach($records as $row)
                        {
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><img src="<?php echo $row['server_image'];?>" style="width:50%; "></td>          
