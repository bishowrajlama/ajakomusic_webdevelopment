                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                     <select name="content_type" class="page_type">
                                        ...
                                        <option value="Why"  <?php echo (isset($content['content_type']) && $content['content_type'] =="Why")?"selected":"";?>>Why Choose us</option>
                                ...
                                <tr valign="top" id="parallex_img">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Parallex Image</label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <?php
                                        if(isset($content['parallex_img']))
                                        {
                                            ...
                                            <div id="image_input1">
                                                ...
                                                <span>(Image Dimension 853*405 px)</span>
                                                <input type="file" name="parallex_img" id="paralleximg">
