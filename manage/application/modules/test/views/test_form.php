                                ...
                                <div class="col-sm-12">
                                    ...
                                    if(isset($records['test_image']))
                                    {
                                        ...
                                        <div class="remove_option">
                                            ...
                                            $path  =  '../uploads/test/';
                                            ?>
                                            <img src="<?php echo $path. $records['test_image'];?>" alt="test_image" style="max-width: 940px; max-height: 360px;">

                                            <span class="btn btn-info remove_btn" id="btn_remove">Remove</span>
                                        </div>
                                        <input type="hidden" name="pre_testimg" value="">
                                        <div id="image_input">
                                            <input type="file" class="form-control" name="test_image" id="test_image">
...
<script>
    ...
    {
        var a=0;
        var ext1 =  $('#test_image').val().split('.').pop().toLowerCase();
