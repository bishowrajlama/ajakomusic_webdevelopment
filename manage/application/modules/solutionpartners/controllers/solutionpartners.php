...
class Solutionpartners extends MX_Controller{
    public function __Construct()
    {
        ...
        $this->load->model('solutionpartners_model','content');
    ...
    public function index()
    {
        ...
        $data['title']= "Solution Partners List";
        $this->load->view('header', $data);
        $this->load->view('solutionpartners_list');
...
//                    exit;
        ...
        $data['title']= "Add/Edit Solution Partners";
        $this->load->view('header', $data);
        $this->load->view('solutionpartners_form');
        $this->load->view('footer');
    }
...
//code to add new tags in content
    ...
    public function send($content_id)
    {
        ...
        if(! empty($content_detail) && $content_detail['content_type'] == 'Article' && ! empty($subscribes))
        {
            ...
            $server_url = $site_settings['site_url'].'/index.php/solutionpartners/detail/'.$content_detail['content_url'];
