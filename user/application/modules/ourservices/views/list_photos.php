  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Photos & Caption For Your Service<br/>(إضافة الصور والتعليق التوضيحي لخدمتك)</h4>
      </div>
      <div class="modal-body">
        
        <form method="POST" action="<?php echo site_url('ourservices/add_photo'); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title_ar" class="form-control" placeholder="عنوان الصورة" required />
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="description_ar" placeholder="تعليق على الصورة" rows="5" class="form-control"></textarea>
            </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php echo $serviceDetail['content_title'];?><br/>
                            ( <?php echo $serviceDetail['content_title_ar'];?> )
                        </td>
                        <td>
...
<div id="editFeatureImage_<?php echo $row['id']; ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Edit Photos & Caption For Your Service<br/> (تحرير الصور والتعليق التوضيحي لخدمتك)</h4>
      </div>
      <div class="modal-body">
        
        <form method="POST" action="<?php echo site_url('ourservices/add_photo/'.$row['id']); ?>" enctype="multipart/form-data">
            <input type="hidden" name="content_id" value="<?php echo $service_id; ?>" />
            <div class="form-group">
                <label>Image Title</label>
                <input type="text" name="title" class="form-control" placeholder="Image Title" value="<?php echo $row['title'];?>" />
                <label>عنوان الصورة</label>
                <input type="text" name="title_ar" class="form-control" placeholder="عنوان الصورة" value="<?php echo $row['title_ar'];?>" required />
            </div>
            ...
            <div class="form-group">
                ...
                <label>تعليق على الصورة</label>
                <textarea name="description_ar" placeholder="تعليق على الصورة" rows="5" class="form-control"><?php echo $row['description_ar'];?></textarea>
            </div>
...
<div id="myModal_delete<?php echo $row['id'];?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <!-- Modal content-->
        <div class="modal-content">
        <form method="POST" action="<?php echo site_url('ourservices/delete_photo/'. $row['id']); ?>">
            <input type="hidden" name="content_id" value="<?php echo $service_id; ?>" />
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Content Delete Confirmation (المحتوى حذف التأكيد)</h4>
            </div>
            <div class="modal-body">
                <p>Are you sure to delete this Information</p>
                <p>هل تريد بالتأكيد حذف هذه المعلومات</p>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel (إلغاء)</button>
                <button type="submit" class="btn btn-default delete">Yes, Delete This (امسح هذه)</button>
            </div>
        </form>
        </div>
