          ...
          <div class="box">
            ...
            <div class="panel-body">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#home" data-toggle="tab">News and Events</a>
                    </li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table content-adjustment">
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Event<span class="asterisk">*</span> </label></th>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                     <select name="content_type" class="page_type form-control">
                                        ...
                                        <option value="EV"  <?php echo (isset($content['content_type']) && $content['content_type'] =="EV")?"selected":"";?>>News & Event</option>
                                ...
                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Date <span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="date" class="form-control" name="ev_date" class="regular-text" data-validation="required"  size="50" value="<?php echo (isset($content['ev_date']) && $content['ev_date'] !="") ? $content['ev_date']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Time <span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="time" class="form-control" name="ev_time" class="regular-text" data-validation="required"  size="50" value="<?php echo (isset($content['ev_time']) && $content['ev_time'] !="") ? $content['ev_time']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
