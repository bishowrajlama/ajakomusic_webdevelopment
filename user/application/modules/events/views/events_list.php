            ...
            <div class="box-body">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <i class="fa fa-plus-square-o"></i><a href="<?php echo site_url('events/form');?>"> Add New Question</a>
                    </div>
                ...
                <?php
                        ...
                        foreach($records as $row)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-success" href="<?php echo site_url('events/form/'. $row['content_id']);?>"  title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                                    ...
                                    <div id="myModal_delete<?php echo $row['content_id'];?>" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <input type="hidden" class="hidden_link_delete" value="<?php echo site_url('events/delete/'. $row['content_id']); ?>">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
