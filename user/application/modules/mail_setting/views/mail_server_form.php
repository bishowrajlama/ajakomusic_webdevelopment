                        ...
                        <div class="tab-pane fade active in" id="home">
                            ...
                            <table class="form-table">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="server_prefix"  class="form-control" data-validation="required" value="<?php echo (isset($setting['server_prefix']) && $setting['server_prefix'] !="") ? $setting['server_prefix']:""; ?>"  autocomplete="off" class="regular-text required valid" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>

                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label for="slogan">Host<span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="host" data-validation="required" class="form-control" value="<?php echo (isset($setting['host']) && $setting['host'] !="") ? $setting['host']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>


                                <tr valign="top">
                                    <th style="background: transparent none repeat scroll 0% 0%;" scope="row"><label>Port<span class="asterisk">*</span> </label></th>
                                    <td style="background: transparent none repeat scroll 0% 0%;"><input type="text" name="port" id="port" data-validation="required" value="<?php echo (isset($setting['port']) && $setting['port'] !="") ? $setting['port']:""; ?>"   autocomplete="off" class="form-control required" kl_virtual_keyboard_secure_input="on"></td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="username" class="form-control" data-validation="required" value="<?php echo (isset($setting['username']) && $setting['username'] !="") ? $setting['username']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="password" name="password" class="form-control" data-validation="required" value="<?php echo (isset($setting['password']) && $setting['password'] !="") ? $setting['password']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="send_from_name"  class="form-control" data-validation="required" value="<?php echo (isset($setting['send_from_name']) && $setting['send_from_name'] !="") ? $setting['send_from_name']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                        <small> ( Example- Amrit Nepali ) </small>
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="email" name="send_from_email"  class="form-control" data-validation="required" value="<?php echo (isset($setting['send_from_email']) && $setting['send_from_email'] !="") ? $setting['send_from_email']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                        <small> ( Example- amritsparsha1@gmail.com  ) </small>
                                    </td>
                                </tr>
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="text" name="reply_to_name"  class="form-control" data-validation="required" value="<?php echo (isset($setting['reply_to_name']) && $setting['reply_to_name'] !="") ? $setting['reply_to_name']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                ...
                                <tr valign="top">
                                    ...
                                    <td style="background: transparent none repeat scroll 0% 0%;">
                                        <input type="email" name="reply_to_email" class="form-control" data-validation="required" value="<?php echo (isset($setting['reply_to_email']) && $setting['reply_to_email'] !="") ? $setting['reply_to_email']:""; ?>" autocomplete="off" kl_virtual_keyboard_secure_input="on">
                                        <small> ( Example- amritsparsha1@gmail.com  ) </small>
                                    </td>
                                </tr>
