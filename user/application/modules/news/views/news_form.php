                                    ...
                                    <div class="form-group"  onclick="showCheckboxes()">
                                        ...
                                        <div id="checkboxes">
                                            ...
                                            foreach($categories as $cat){
                                                ...
                                                ?>
                                            <lable for="one">
                                            <input name="category_id[]" type="checkbox" value="<?php echo $cat['category_id'] ?>" <?php echo (isset($content['category_id']) && $content['category_id'] ==$cat['category_id'])?"selected":"";?>><?php echo $cat['category_name']; ?>
                                            </lable>
                                            <?php
