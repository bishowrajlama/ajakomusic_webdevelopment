...
<div id="home" class="tab-pane fade in active">
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="hidden" name="tourcode" id="inputCattitle"

                       class="form-control"
                       value="<?php echo (isset($package['tourcode']) !="") ? $package['tourcode']:""; ?>">
            </div>
        </div>
    </div><!--row-->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <input type="text" name="product_size" class="form-control" id="product_size" value="<?php echo (isset($package['product_size']) !="") ? $package['product_size']:""; ?>" data-validation="required">
            ...
            <div class="form-group">
                <select class="form-control" name="category_id" data-validation="required">
                    ...
                    foreach($categories as $cat){
                        ...
                        ?>
                        <option value="<?php echo $cat['category_id'] ?>" <?php echo (isset($package['category_id']) && $package['category_id'] ==$cat['category_id'])?"selected":"";?>><?php echo $cat['category_name']; ?>
...
<div id="menu3" class="tab-pane fade">
    ...
    <div id="menu1" class="tab-pane fade">
        <div class="row">
            <div class="col-md-2"><label>Specification</label></div>
            <div class="col-md-8">
                <div class="form-group">
