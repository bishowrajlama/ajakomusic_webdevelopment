...
//            exit;
            ...
            $this->form_validation->set_rules('product_size', 'product_size');
        ...
        $product_code = rand(0000,9999);
            ...
            $insert['tourcode']=  strtoupper($product_code);
            ...
            if($package_id == "0")
            {
                ...
                $insert['tourcode'] = $this->input->post('tourcode');
