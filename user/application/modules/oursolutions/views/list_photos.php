  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?php echo site_url('oursolutions/add_photo'); ?>" enctype="multipart/form-data">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="<?php echo site_url('oursolutions/add_photo/'.$row['id']); ?>" enctype="multipart/form-data">
            <input type="hidden" name="content_id" value="<?php echo $service_id; ?>" />
            <div class="form-group">
                <label>Image Title</label>
...
<div id="myModal_delete<?php echo $row['id'];?>" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <!-- Modal content-->
        <div class="modal-content">
        <form method="POST" action="<?php echo site_url('oursolutions/delete_photo/'. $row['id']); ?>">
            <input type="hidden" name="content_id" value="<?php echo $service_id; ?>" />
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
